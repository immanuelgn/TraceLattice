import type { CookieFinding, HeaderFinding, TrackerFinding } from "./types";

export function buildRecommendations(headers: HeaderFinding[], cookies: CookieFinding[], trackers: TrackerFinding[], thirdPartyCount: number) {
